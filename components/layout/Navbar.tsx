      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16 sm:h-18">
          ...
          <div className="hidden lg:flex items-center gap-3">
            ...
            <Link
              href="/dashboard"
              className="inline-flex items-center gap-2 px-4 py-2 rounded-xl bg-primary text-white text-sm font-semibold hover:bg-primary-container transition-all shadow-sm active:scale-95"
            >
      ...
      {mobileMenuOpen && (
        <div className="md:hidden border-t border-surface-container bg-white px-4 pt-3 pb-6 space-y-3">
          ...
          <div className="pt-3 border-t border-surface-container space-y-2">
            <div className="flex items-center gap-2 px-3 py-1.5 text-xs font-mono text-on-surface-variant">
            ...
            <Link
              href="/dashboard"
              onClick={() => setMobileMenuOpen(false)}
              className="flex items-center justify-center gap-2 w-full px-4 py-2.5 rounded-xl bg-primary text-white font-semibold text-sm shadow-sm"
            >
              <span>Launch Dashboard</span>
              <ArrowRight className="w-4 h-4" />
            </Link>
