...
[![Smart India Hackathon 2026]\([https://img.shields.io/badge/SIH-2026-teal.svg)\](https://sih.gov.in](https://img.shields.io/badge/SIH-2026-teal.svg\)]\(https://sih.gov.in))

[![Category]\([https://img.shields.io/badge/Track-MedTech%20%2F%20HealthTech-blue.svg)\](#](https://img.shields.io/badge/Track-MedTech%20%2F%20HealthTech-blue.svg\)]\(#))

[![Problem Statement]\([https://img.shields.io/badge/Problem%20ID-26181-orange.svg)\](#](https://img.shields.io/badge/Problem%20ID-26181-orange.svg\)]\(#))

[![License]\([https://img.shields.io/badge/Privacy-Zero%20Medical%20Data%20Stored-green.svg)\](#](https://img.shields.io/badge/Privacy-Zero%20Medical%20Data%20Stored-green.svg\)]\(#))
...
\- **\*\*Frontend Framework\*\***: [Next.js 14 (App Router)]\([https://nextjs.org/](https://nextjs.org/)) with TypeScript

\- **\*\*Styling & Design Tokens\*\***: [Tailwind CSS]\([https://tailwindcss.com/](https://tailwindcss.com/)) with a restrained clinical-telemetry palette (\`#035657\` deep teal, coral alert accent, atmospheric navy)
...
git clone [https://github.com/your-team/swasthyasathi-ai.git](https://github.com/your-team/swasthyasathi-ai.git)
...
2\. Import the project into [Vercel]\([https://vercel.com](https://vercel.com)).
...
© 2026 SwasthyaSathi AI Team. Built for Smart India Hackathon 2026 (Problem Statement 26181). this is the readme file 
